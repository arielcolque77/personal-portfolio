          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://www.linkedin.com/in/arielcolque"><img src={navIcon1} alt="" /></a>
                <a href="https://www.facebook.com/ariel.aru16"><img src={navIcon2} alt="" /></a>
                <a href="https://www.instagram.com/arii_9577"><img src={navIcon3} alt="" /></a>
              </div>
              <HashLink to='#connect'>
